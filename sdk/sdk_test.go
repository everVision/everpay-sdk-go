...
func TestSDK_Transfer(t *testing.T) {
	...
	// amount := big.NewInt(1)
	// result, err := testSDK.Transfer("bsc-tusdc-0xf17a50ecc5fe5f476de2da5481cdd0f0ffef7712", amount, to, `{"msg": "hello"}`)
	// assert.NoError(t, err)
...
func TestClient_SubmitBundleTx(t *testing.T) {
	...
	// bundleSigs := schema.BundleWithSigs{
	// 	Bundle: bundle,
	...
	// res, err := sdk01.Bundle("bsc-tusdc-0xf17a50ecc5fe5f476de2da5481cdd0f0ffef7712", addr01, nil, bundleSigs)
	// assert.NoError(t, err)
	// t.Log(res.HexHash())
}
